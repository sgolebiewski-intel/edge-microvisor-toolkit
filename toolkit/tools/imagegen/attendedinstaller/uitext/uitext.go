...
const (
	...
	// Auto partition
	DiskHelp  = "Please select a disk to install Edge Microvisor Toolkit on."
...
// EulaView text.
const (
	EulaTitle = "Welcome to the Edge Microvisor Toolkit Installer"
)
...
// ProgressView text.
const (
	ProgressTitle      = "Installing Edge Microvisor Toolkit"
	ProgressSpinnerFmt = "Installing Edge Microvisor Toolkit, please wait %v"
)

// FinishView text.
const (
	FinishTitle   = "Edge Microvisor Toolkit Installation Complete"
