...
sed -i "s|prefix?=%{_prefix}/local|prefix?=/usr|" config.mk
...
%changelog
* Tue Dec 03 2024 Aaron Chan Chun Yew <aaron.chun.yew.chan@intel.com> - 2.0-19-1
- Update to 2.0.19. Fix CVE-2024-8376.

* Wed Jul 17 2024 Teoh Suh Haw <suh.haw.teoh@intel.com> - 2.0.18-4
