...
Source0:        https://github.com/eclipse-paho/paho.mqtt.python/archive/refs/tags/v%{version}.tar.gz#/%{name}-%{version}.tar.gz
...
%doc CONTRIBUTING.md README.rst about.html
%license LICENSE.txt notice.html
%{python3_sitelib}/paho/
%{python3_sitelib}/paho*.egg-info

%changelog
* Tue Jan 07 2025 Naveen Saini <naveen.kumar.saini@intel.com> - 1.6.1-14
- Fix license installation.

* Mon Dec 30 2024 Naveen Saini <naveen.kumar.saini@intel.com> - 1.6.1-13
- Update Source URL.

* Thu Dec 19 2024 Mun Chun Yep <mun.chun.yep@intel.com> - 1.6.1-12
- Add vendor and distribution tag.

* Mon Sep 09 2024 Mun Chun Yep <mun.chun.yep@intel.com> - 1.6.1-11
