...
touch %{buildroot}%{_sysconfdir}/cron.allow
...
%config(noreplace) %{_sysconfdir}/cron.allow
%attr(740,root,root) %{_sysconfdir}/cron.allow
...
%changelog
* Tue Jan 21 2025 Mun Chun Yep <mun.chun.yep@intel.com> - 1.6.1-2
- Remove cron.deny, create cron.allow
