...
%changelog
* Fri Feb 21 2025 Liu Lishan <lishan.liu@intel.com> - 4.2-2
- Add glibc-iconv as Recommends to resolve invalid argument error when running mkfs.vfat
