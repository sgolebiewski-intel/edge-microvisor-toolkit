...
[selection of discrete GPU cards](./docs/developer-guide/get-started/emt-system-requirements.md#hardware-requirements).
...
* [Hardware and software system requirements](./docs/developer-guide/get-started/emt-system-requirements.md)
